...
Original file is located at
    https://colab.research.google.com/drive/1fEqXlfErPurNm5eBZudtSzLwnZLnX_th
"""
...
epochs = 100  # Increased max epochs to accommodate early stopping
patience = 5
best_val_acc = 0.0
counter = 0
...
for epoch in range(epochs):
    ...
    print(f"Epoch {epoch+1}: Train Acc={train_acc:.4f}, Val Acc={val_acc:.4f}, Loss={train_loss:.4f}")
