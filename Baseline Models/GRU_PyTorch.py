...
class GRUClassifier(nn.Module):
    def __init__(self, input_size, hidden_size, num_classes):
        ...
        self.gru2 = nn.GRU(hidden_size, hidden_size, batch_first=True, bidirectional=False)
...
model = GRUClassifier(input_size, 128, num_classes).to(device)
...
}).to_csv("gru_training_history.csv", index=False)
...
plt.legend()
plt.grid(True)
plt.savefig("gru_accuracy_history.png")
plt.show()
...
plt.legend()
plt.grid(True)
plt.savefig("gru_loss_history.png")
plt.show()
